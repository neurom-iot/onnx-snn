...
#block 1
model.add(Conv2D(input_shape = (input_shape[0], input_shape[1], 1), filters = 64, kernel_size = (3, 3), strides=(1, 1), padding = 'same', name = 'block1_conv1'))
...
tensorboard = TensorBoard(log_dir='vgg19logs/{}'.format(time.time()), histogram_freq=0, write_graph=True, write_images=True)
